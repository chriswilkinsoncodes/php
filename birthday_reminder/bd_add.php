...
if(isset($_POST['submit'])) {
    ...
    if($ok) {
        ...
        $sql = sprintf(
            "INSERT INTO birthdays (firstname, lastname, birthday, category, acknowledgement,
            budget, actual, reminder, ideas) VALUES ('%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s')",
...
<form
    ...
    Reminder: <input type="text" name="reminder_num" value="<?php echo $reminder_num?>"><br>
        <select name="reminder_period" id="">
            <option value="">Select reminder period...</option>
            <option value="d" <?php if ($reminder_period === 'd') echo ' selected' ?>>day(s)</option>
            <option value="w" <?php if ($reminder_period === 'w') echo ' selected' ?>>week(s)</option>
            <option value="m" <?php if ($reminder_period === 'm') echo ' selected' ?>>month(s)</option>
        </select><br>
    Gift Ideas:<br>
